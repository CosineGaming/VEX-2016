#pragma config(Motor,  port1,           picollo,tmotorNormal, openLoop)
...
#pragma config(Motor,  port6,           rb,     tmotorNormal, openLoop, reversed) //
#pragma config(Motor,  port7,           lb,     tmotorNormal, openLoop)           //
